...
const whitelist = ['https://javer.com.mx', 'https://www.javer.com.mx', 'https://buzonjaver.com'];
const corsOptions = {
...
app.post("/enviar-correo", (req, res) => {
  ...
  let mailOptions = {
    ...
    to: "ctrevinov@javer.com.mx", // Dirección de correo a la que se enviará el formulario
